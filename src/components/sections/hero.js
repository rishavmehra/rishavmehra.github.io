...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Rishav Mehra.</h2>;
  ...
  const five = (
    <a
      ...
      href="https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcSGLPqSGQQhFNmhLKZhsLNgMVfldtjLwFzSDdjGzDfrLlXdxqGcGptTdFsNLWkzTNXdCCJnH"
      target="_blank"
      rel="noreferrer">
      Get in touch
    </a>
